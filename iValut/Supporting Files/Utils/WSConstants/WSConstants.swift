struct WebService {
    static let baseUrl                               = "https://api.ivalt.com/admin/public/api/webcard"
    static let privacyPolicy                         = "https://ivalt.com/privacypolicy-eula.html"
    static let register                              = "\(baseUrl)/register/mobile/user"
    static let registeredUserDetail                  = "\(baseUrl)/registered-user-details"
    ...
    static let updateToken                           = "\(baseUrl)/mobile/refresh/token"
    static let global                                = "\(baseUrl)/global/authenticate"
    static let deleteUser                            = "\(baseUrl)/remove-user"
    static let checkStatus                           = "\(baseUrl)/user/details"
